/**
 * @file comunicacao.c
 * @brief Gerencia a comunicação do ESP
 * @version 0.1
 * @date 2022-06-15
 */
...
// Sinaliza quando houver conexão
                          ...
                          int32_t event_id, void *event_data)
{
    ...
    else if (event_base == WIFI_EVENT && event_id == WIFI_EVENT_STA_DISCONNECTED)
    {
        ...
        {
            xEventGroupSetBits(comm_event_group, WIFI_FAIL_BIT);
        }
...
void wifi_init(void)
{
    ...
    EventBits_t bits = xEventGroupWaitBits(comm_event_group,
